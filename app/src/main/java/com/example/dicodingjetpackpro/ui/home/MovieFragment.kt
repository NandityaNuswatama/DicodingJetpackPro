...
import com.example.dicodingjetpackpro.ui.detail.DetailFragment.Companion.EXTRAS
import com.example.dicodingjetpackpro.ui.detail.DetailFragment.Companion.EXTRA_ID
import com.example.dicodingjetpackpro.ui.detail.DetailFragment.Companion.MOVIE
    ...
    private fun initRecyclerview(){
        binding.rvListGeneral.apply {
            ...
            lifecycleScope.launchWhenCreated {
                mViewModel.getMovieList().collectLatest {
            ...
            mAdapter.setOnItemClickCallback(object : RecyclerViewAdapter.OnItemClickCallback {
                override fun onItemClicked(myModel: MyModel) {
                    findNavController().navigate(R.id.action_homeFragment_to_detailFragment, bundleOf(EXTRA_ID to myModel, EXTRAS to MOVIE))
                }
            })
        }
    }
